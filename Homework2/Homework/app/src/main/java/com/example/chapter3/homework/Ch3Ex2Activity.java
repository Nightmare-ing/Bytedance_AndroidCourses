...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        AnimatorSet animator2_set = new AnimatorSet();
        ...
        animator2_set.playTogether(animator2_X, animator2_Y);
        animator2_set.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        ...
        animatorSet.playTogether(animator1, animator2_set, animator3);
        animatorSet.start();
    }
}
